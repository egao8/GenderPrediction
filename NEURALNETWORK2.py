...
Prompt: You may want to go to a Kanye concert.
In order to decide if you want to go, you weigh factors that alter your final decision/output.
1. Is the weather good?
2. Does your friend(s) want to come with you?
3. Is the concert nearby?
Suppose you care most about if the weather is good (no.1) and care about the location of the concert least (no.3)...
(weights) 
w1 = 6 for weather
w2 = 4 (friends)
w3 = 1 (travel time)
Thus, by weighing certain factors heavier, they matter more. Mathematically, this is represented with...
y = f(x1 * w1 + x2 * w2 + b)
